...
public:
  ...
  enum {
    ...
    RuleBackgroundStmt = 4, RuleMusicStmt = 5, RuleSoundStmt = 6, RuleCharacterDef = 7, 
    RuleCharacterBody = 8, RuleCharPropStmt = 9, RuleSayStmt = 10, RuleNarrateStmt = 11, 
    RuleVarDecl = 12, RuleSetStmt = 13, RuleLvalue = 14, RuleAssignOp = 15, 
    RuleIfStmt = 16, RuleBlock = 17, RuleChoiceStmt = 18, RuleChoiceOption = 19, 
    RuleParallelStmt = 20, RuleFunctionDef = 21, RuleTryCatchStmt = 22, 
    RuleSavepointStmt = 23, RuleTransitionStmt = 24, RuleImportStmt = 25, 
    RuleDebugBlock = 26, RuleGotoStmt = 27, RuleAnimateStmt = 28, RulePlayStmt = 29, 
    RuleWaitStmt = 30, RuleReturnStmt = 31, RuleLogStmt = 32, RuleExpr = 33
  };
  ...
  class  SoundStmtContext : public antlr4::ParserRuleContext {
  public:
    SoundStmtContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *STRING();
    antlr4::tree::TerminalNode *SEMICOLON();
  ...
  class  SayStmtContext : public antlr4::ParserRuleContext {
  public:
    SayStmtContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *ID();
    antlr4::tree::TerminalNode *STRING();
    antlr4::tree::TerminalNode *SEMICOLON();
  ...
  class  ParallelStmtContext : public antlr4::ParserRuleContext {
  public:
    ParallelStmtContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    BlockContext *block();
  ...
  class  TransitionStmtContext : public antlr4::ParserRuleContext {
  public:
    TransitionStmtContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *ID();
    ExprContext *expr();
    BlockContext *block();
  ...
  class  DebugBlockContext : public antlr4::ParserRuleContext {
  public:
    DebugBlockContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    BlockContext *block();
  ...
  class  AnimateStmtContext : public antlr4::ParserRuleContext {
  public:
    AnimateStmtContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *ID();
    antlr4::tree::TerminalNode *STRING();
    antlr4::tree::TerminalNode *SEMICOLON();
  ...
  class  LogStmtContext : public antlr4::ParserRuleContext {
  public:
    LogStmtContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ExprContext *expr();
    antlr4::tree::TerminalNode *SEMICOLON();
